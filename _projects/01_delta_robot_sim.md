...
<p class="delta-sim-credit">Built on the <a href="https://github.com/alexandergmzx/Delta_ROS2">Delta ROS 2</a> project. The robot model is the CAD of the delta robot kit from the RWTH International Academy summer school <a href="https://www.academy.rwth-aachen.de/en/programs/short-courses/detail/summer-school-robot-operating-systems-essentials">Robot Operating Systems Essentials</a> (<a href="https://www.igmr.rwth-aachen.de/">IGMR, RWTH Aachen University</a>, 2025) — course material, all rights reserved, shown with attribution for a non-commercial portfolio (see the repository's <a href="https://github.com/alexandergmzx/Delta_ROS2/blob/main/NOTICE">NOTICE</a>). The inverse kinematics were written with <a href="https://github.com/armandorodb">Armando Rodriguez</a>; the browser simulator, trajectory engine, and dashboard are by Alexander Gomez.</p>
