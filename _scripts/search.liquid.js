          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/garden/" -%}{%- assign url = "/garden/" -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/garden/" -%}{%- assign url = "/garden/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
